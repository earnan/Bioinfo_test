...
##########################################################
#
#       Filename:   gfa_remove_overlap_V2.0.py
#         Author:   yujie
#    Description:   gfa_remove_overlap_V2.0.py
#        Version:   2.0
#           Time:   2022/08/13 21:14:03
#  Last Modified:   2022/08/13 21:14:03
...
##########################################################\n\
\n\
python3   gfa_remove_overlap_V2.0.py\n\
功能：\n\
1.常规使用\n\
1.1 -i [ ] -o [ ] \n\
2.其他使用\n\
...
\n\
##########################################################\n\
Path: E:\OneDrive\jshy信息部\Script\Bioinfo_test\gfa_remove_overlap_V2.0.py\n\
Path: /share/nas1/yuj/script/Bioinfo_test/gfa_remove_overlap_V2.0.py\n\
Version: 2.0\n\
##########################################################\n\
'
)
